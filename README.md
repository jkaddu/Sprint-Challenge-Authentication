...
Sessions are commonly used so the server can store info about the client. We've been using it for authentication so there's no need to re-enter credentials.

1. What does bcrypt do to help us store passwords in a secure manner.

It encrypts and stores the passwords in hash form.

1. What does bcrypt do to slow down attackers?

Uses key derivation to add time to security algorithms.

1. What are the three parts of the JSON Web Token?

The header, payload and secret.
